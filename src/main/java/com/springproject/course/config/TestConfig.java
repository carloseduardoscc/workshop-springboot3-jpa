...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception { //Configurações executadas automaticamente com o início da aplicação
		...
		Order o1 = new Order(null, Instant.parse("2024-06-15T13:42:50Z"), u1);
		Order o2 = new Order(null, Instant.parse("2024-05-30T22:40:20Z"), u2);
		Order o3 = new Order(null, Instant.parse("2024-06-14T12:31:10Z"), u1);
